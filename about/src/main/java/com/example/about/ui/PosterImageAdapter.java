...
public final class PosterImageAdapter extends PagerAdapter {
  ...
  public Object instantiateItem(ViewGroup container, int position) {
    final SubsamplingScaleImageView view = (SubsamplingScaleImageView) LayoutInflater.from(container.getContext()).inflate(R.layout.about_poster_layout, container, false);
